...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        QtCore.QObject.connect(self.pasteButton, QtCore.SIGNAL(_fromUtf8("clicked()")),self.paste) 
    ...
    def retranslateUi(self, mainWindow):
        mainWindow.setWindowTitle(_translate("mainWindow", "STIX packet parser", None))
