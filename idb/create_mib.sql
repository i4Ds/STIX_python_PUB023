DROP TABLE IF EXISTS A_User_Config_Table_TC_Is_Referenced;
...
DROP TABLE IF EXISTS DPF;
DROP TABLE IF EXISTS DST;
DROP TABLE IF EXISTS GPC;
DROP TABLE IF EXISTS GPF;
DROP TABLE IF EXISTS GRP;
DROP TABLE IF EXISTS GRPA;
DROP TABLE IF EXISTS GRPK;
...
DROP TABLE IF EXISTS PCDF;
DROP TABLE IF EXISTS PCF;
DROP TABLE IF EXISTS PCPC;
...
DROP TABLE IF EXISTS SSY;
DROP TABLE IF EXISTS tblCAFselectCAFengfmt;
DROP TABLE IF EXISTS tblCAFselectCAFinter;
DROP TABLE IF EXISTS tblCAFselectCAFradix;
DROP TABLE IF EXISTS tblCAFselectCAFrawfmt;
DROP TABLE IF EXISTS tblCategoryRules;
DROP TABLE IF EXISTS tblCCFbufferCCF;
DROP TABLE IF EXISTS tblCCFbufferCDF;
DROP TABLE IF EXISTS tblCCFbufferCVP;
DROP TABLE IF EXISTS tblCCFbufferPTV;
DROP TABLE IF EXISTS tblCCFselectCCFctype;
DROP TABLE IF EXISTS tblCCFselectCCFilscope;
DROP TABLE IF EXISTS tblCCFselectCCFilstage;
DROP TABLE IF EXISTS tblCCFselectCCFsubsys;
DROP TABLE IF EXISTS tblCCFselectCCFyesNo;
DROP TABLE IF EXISTS tblCCFselectCDFeltype;
DROP TABLE IF EXISTS tblCCFselectCDFinter;
DROP TABLE IF EXISTS tblCheckConfig;
DROP TABLE IF EXISTS tblCheckDescription;
DROP TABLE IF EXISTS tblCheckErrors;
DROP TABLE IF EXISTS tblCheckPLFRangeConfig;
DROP TABLE IF EXISTS tblCheckSupportSDFCompletenessCDF;
DROP TABLE IF EXISTS tblCheckSupportSDFCompletenessCSP;
DROP TABLE IF EXISTS tblConfigKeys;
DROP TABLE IF EXISTS tblConfigS2KParameterTypes;
DROP TABLE IF EXISTS tblConfigSCOSTables;
DROP TABLE IF EXISTS tblConfigStdCalPAF;
DROP TABLE IF EXISTS tblConfigStdCalPAS;
DROP TABLE IF EXISTS tblConfigStdCalTXF;
DROP TABLE IF EXISTS tblConfigStdCalTXP;
DROP TABLE IF EXISTS tblConfiguration;
DROP TABLE IF EXISTS tblCPCbufferCPC;
DROP TABLE IF EXISTS tblCPCselectCPCcateg;
DROP TABLE IF EXISTS tblCPCselectCPCdispfmt;
DROP TABLE IF EXISTS tblCPCselectCPCinter;
DROP TABLE IF EXISTS tblCVSselectCVEcheck;
DROP TABLE IF EXISTS tblCVSselectCVEinter;
DROP TABLE IF EXISTS tblCVSselectCVSsource;
DROP TABLE IF EXISTS tblCVSselectCVStype;
DROP TABLE IF EXISTS tblDBMtables;
DROP TABLE IF EXISTS tblExportLog;
DROP TABLE IF EXISTS tblImportLog;
DROP TABLE IF EXISTS tblLogChangeLogTemp;
DROP TABLE IF EXISTS tblOCFselectOCFcodin;
DROP TABLE IF EXISTS tblOCFselectOCFinter;
DROP TABLE IF EXISTS tblOCFselectOCPtype;
DROP TABLE IF EXISTS tblPacketFilingConfig;
DROP TABLE IF EXISTS tblPayloadChecks;
DROP TABLE IF EXISTS tblPCFbufferOCF;
DROP TABLE IF EXISTS tblPCFbufferPCF;
DROP TABLE IF EXISTS tblPCFbufferPLF;
DROP TABLE IF EXISTS tblPCFselectPCFcateg;
DROP TABLE IF EXISTS tblPCFselectPCFinter;
DROP TABLE IF EXISTS tblPCFselectPCFnatur;
DROP TABLE IF EXISTS tblPCFselectPCFstype;
DROP TABLE IF EXISTS tblPCFselectVPDchoice;
DROP TABLE IF EXISTS tblPCFselectVPDdchar;
DROP TABLE IF EXISTS tblPCFselectVPDform;
DROP TABLE IF EXISTS tblPCFselectVPDjustify;
DROP TABLE IF EXISTS tblPCFselectVPDnewline;
DROP TABLE IF EXISTS tblPCFselectVPDpidref;
DROP TABLE IF EXISTS tblPICrule;
DROP TABLE IF EXISTS tblSVNimportLog;
DROP TABLE IF EXISTS tblTableDef;
DROP TABLE IF EXISTS tblTCPselectPCDFradix;
DROP TABLE IF EXISTS tblTCPselectPCDFtype;
DROP TABLE IF EXISTS tblTCPselectPCPCcode;
DROP TABLE IF EXISTS tblTempVPD_OFFBI;
DROP TABLE IF EXISTS tblTPCFselectPIDcheck;
DROP TABLE IF EXISTS tblTPCFselectPIDevent;
DROP TABLE IF EXISTS tblTPCFselectPIDtime;
DROP TABLE IF EXISTS tblTPCFselectPIDvalid;
DROP TABLE IF EXISTS tblTXFselectTXFrawfmt;
DROP TABLE IF EXISTS TCP;
DROP TABLE IF EXISTS TPCF;
DROP TABLE IF EXISTS TXF;
DROP TABLE IF EXISTS TXP;
DROP TABLE IF EXISTS VDF;
DROP TABLE IF EXISTS CVP;
DROP TABLE IF EXISTS OCF;
DROP TABLE IF EXISTS Paste;
DROP TABLE IF EXISTS Errors;
DROP TABLE IF EXISTS PID;
DROP TABLE IF EXISTS PSM;
DROP TABLE IF EXISTS SDF;
DROP TABLE IF EXISTS SW_PARA;
DROP TABLE IF EXISTS tblCCAselectCCAtype;
DROP TABLE IF EXISTS tblCCFselectCCFplan;
DROP TABLE IF EXISTS tblChangeLog;
DROP TABLE IF EXISTS tblConfig;
DROP TABLE IF EXISTS tblConfigStdCalPCF;
DROP TABLE IF EXISTS tblCPCselectCPCradix;
DROP TABLE IF EXISTS tblLogChangeLogDef;
DROP TABLE IF EXISTS tblPCFbufferOCP;
DROP TABLE IF EXISTS tblPCFselectPCFuscon;
DROP TABLE IF EXISTS tblSVNexportLog;
