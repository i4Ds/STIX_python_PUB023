...
def process_packets_in_database():
    ...
    optional.add_argument(
        ...
        required=False,
        help=
        "Get a list of unprocessed runs from MongoDB and process all of them.")
    ...
    optional.add_argument(
        ...
        required=False,
        help=
        "Output filename. PDF files are stored in folder {} if not specified.".
        format(OUTPUT_PDF_DIRECTORY))
