...
------------------------------------------------------------------------------
   ...
   Heliospheric Coordinate Frames developed for the NASA STEREO mission:
      ...
      SOLO_GSE                    Geocentric Solar Ecliptic Frame
   ...
   IDs:
      ...
      SOLO_GSE                      EARTH       DYNAMIC     -144981
      SOLO_HCI                      SUN         DYNAMIC     -144982
      SOLO_HEE_NASA                 SUN         DYNAMIC     -144983
      SOLO_HEEQ                     SUN         DYNAMIC     -144984
      SOLO_GEORTN                   SUN         DYNAMIC     -144985
...
------------------------------------------------------------------------
   ...
   follows (from [10]):
      ...
      -  the position of Sun relative to SOLO is the 
         primary vector: +X axis points from the SOLO to
         Sun;
  ...
  \begindata
      ...
      FRAME_-144991_PRI_OBSERVER     = 'SOLO'
      FRAME_-144991_PRI_TARGET       = 'SUN'
...
------------------------------------------------------------------------
   ...
   different axis lablelling. It is almost ``helioprojective'' except that the
...
------------------------------------------------------------------------
   ...
   using pck00009.tpc and pck00010.tc.  
...
------------------------------------------------------------------------
  ...
  \begindata
      ...
      FRAME_-144996_SEC_FRAME      = 'EARTH_MECL_MEQX'
      FRAME_-144996_SEC_SPEC       = 'RECTANGULAR'
      FRAME_-144996_SEC_VECTOR     = ( 0, 0, 1 )
      FRAME_-144996_FREEZE_EPOCH   = @2000-JAN-1/12:00:00.000
...
------------------------------------------------------------------------
  ...
  \begindata
      ...
      FRAME_-144997_SEC_FRAME      = 'EARTH_MECL_MEQX'
      FRAME_-144997_SEC_SPEC       = 'RECTANGULAR'
      FRAME_-144997_SEC_VECTOR     = ( 0, 0, 1 )
      FRAME_-144997_FREEZE_EPOCH     = @2000-JAN-1/12:00:00.000
...
Geocentric Solar Ecliptic Frame (SOLO_GSE)
------------------------------------------------------------------------

   Definition:
   ----------
   The Geocentric Solar Ecliptic frame is defined as follows (from[17]):

      - +X axis points from the Earth to the Sun;

      - + Z axis is the otrhogonal component to the +X axis of the northern
   ...
   \begindata
        ...
        FRAME_SOLO_GSE               =  -144981
        FRAME_-144981_NAME           = 'SOLO_GSE'
        FRAME_-144981_CLASS          =  5
        FRAME_-144981_CLASS_ID       =  -144981
        FRAME_-144981_CENTER         =  399
        FRAME_-144981_RELATIVE       = 'J2000'
        FRAME_-144981_DEF_STYLE      = 'PARAMETERIZED'
        FRAME_-144981_FAMILY         = 'TWO-VECTOR'
        FRAME_-144981_PRI_AXIS       = 'X'
        FRAME_-144981_PRI_VECTOR_DEF = 'OBSERVER_TARGET_POSITION'
        FRAME_-144981_PRI_OBSERVER   = 'EARTH'
        FRAME_-144981_PRI_TARGET     = 'SUN'
        FRAME_-144981_PRI_ABCORR     = 'NONE'
        FRAME_-144981_SEC_AXIS       = 'Z'
        FRAME_-144981_SEC_VECTOR_DEF = 'CONSTANT'
        FRAME_-144981_SEC_FRAME      = 'SOLO_ECLIPDATE'
...
------------------------------------------------------------------------
   ...
   \begindata
        ...
        FRAME_SOLO_HCI               =  -144982
        FRAME_-144982_NAME           = 'SOLO_HCI'
        ...
        FRAME_-144982_FREEZE_EPOCH   = @2000-JAN-01/12:00:00
        FRAME_-144982_PRI_AXIS       = 'Z'
        FRAME_-144982_PRI_VECTOR_DEF = 'CONSTANT'
        FRAME_-144982_PRI_FRAME      = 'IAU_SUN'
        FRAME_-144982_PRI_SPEC       = 'RECTANGULAR'
        FRAME_-144982_PRI_VECTOR     = ( 0, 0, 1 )
        FRAME_-144982_SEC_AXIS       = 'Y'
        FRAME_-144982_SEC_VECTOR_DEF = 'CONSTANT'
        FRAME_-144982_SEC_FRAME      = 'ECLIPJ2000'
...
------------------------------------------------------------------------
   ...
   \begindata
        ...
        FRAME_SOLO_HEE_NASA          =  -144983
        FRAME_-144983_NAME           = 'SOLO_HEE_NASA'
        ...
        FRAME_-144983_PRI_AXIS       = 'X'
        FRAME_-144983_PRI_VECTOR_DEF = 'OBSERVER_TARGET_POSITION'
        FRAME_-144983_PRI_OBSERVER   = 'SUN'
        FRAME_-144983_PRI_TARGET     = 'EARTH'
        FRAME_-144983_PRI_ABCORR     = 'NONE'
        FRAME_-144983_SEC_AXIS       = 'Z'
        FRAME_-144983_SEC_VECTOR_DEF = 'CONSTANT'
        FRAME_-144983_SEC_FRAME      = 'SOLO_ECLIPDATE'
        FRAME_-144983_SEC_SPEC       = 'RECTANGULAR'
        FRAME_-144983_SEC_VECTOR     = ( 0, 0, 1 )
...
------------------------------------------------------------------------
   ...
   \begindata
        ...
        FRAME_SOLO_HEEQ              =  -144984
        FRAME_-144984_NAME           = 'SOLO_HEEQ'
        ...
        FRAME_-144984_PRI_AXIS       = 'Z'
        FRAME_-144984_PRI_VECTOR_DEF = 'CONSTANT'
        FRAME_-144984_PRI_FRAME      = 'IAU_SUN'
        FRAME_-144984_PRI_SPEC       = 'RECTANGULAR'
        FRAME_-144984_PRI_VECTOR      = ( 0, 0, 1 )
        FRAME_-144984_SEC_AXIS       = 'X'
        FRAME_-144984_SEC_VECTOR_DEF = 'OBSERVER_TARGET_POSITION'
        FRAME_-144984_SEC_OBSERVER   = 'SUN'
        FRAME_-144984_SEC_TARGET     = 'EARTH'
        FRAME_-144984_SEC_ABCORR     = 'NONE'
...
\begindata
        ...
        FRAME_SOLO_GEORTN            =  -144985
        FRAME_-144985_NAME           = 'SOLO_GEORTN'
