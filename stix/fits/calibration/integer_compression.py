"""
STIX integer compression a quasi-exponential 1 byte compression of integer data, both positive
...
The algorithms that I (GH) remember were used on the Electron Isotope Spectrometers (E..C.Stone, PI)
that flew on IMPs 7 and 8, launched in 1972 and 1973?.
"""
