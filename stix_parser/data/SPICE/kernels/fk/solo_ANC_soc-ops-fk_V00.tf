...
-------------------------------------------------------------------------------
   ...
   The following frames are defined in this kernel file:
      ...
      SOLO_SOLAR_NORM            SOLO Solar-NORM pointing @ Sun
   ...
   IDs:
      ...
      SOLO_SOLAR_NORM           SOLO                   DYNAMIC  -144901   
...
------------------------------------------------------------------------
   ...
   defined as followed:
      ...
      - Solar-NORM: +Z axis projected to Solar North. 
        This secondary direction should not be aberration corrected [TBC]
...
SOLO Solar-NORM pointing frame (SOLO_SOLAR_NORM):
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

   According to [4] the SOLO Spacecraft Solar-NORM reference frame 
   -- SOLO_SOLAR_NORM -- is defined as follows:
   ...
   \begindata
      ...
      FRAME_SOLO_SOLAR_NORM          = -144901
      FRAME_-144901_NAME             = 'SOLO_SOLAR_NORM'
      ...
      FRAME_-144901_SEC_SPEC         = 'CARTESIAN'
      FRAME_-144901_SEC_VECTOR       = ( 0, 0, 1 )

   \begintext


SOLO Ecliptic-NORM pointing frame (SOLO_ECLIPT_NORM):
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   The secondary vector is defined as a constant vector in the J2000 frame, 
   which provides the Celestial North.
   ...
   \begindata
      ...
      FRAME_-144902_SEC_FRAME        = 'J2000'
      FRAME_-144902_SEC_SPEC         = 'CARTESIAN'
