...
Frame (FK) kernel file for SOLO Spacecraft Equatorial-Normal Pointing 
===============================================================================

   This frames kernel overwrites the SOLO spacecraft frame (SOLO_PRF)
   definition from [3] and maps it to the SOLO Equatorial-NORM pointing @ Sun
   frame (SOLO_EQUAT_NORM) defined in [4].
   ...
   MAPPED TO THE SOLO_EQUAT_NORM FRAME, AND ANY CK PROVIDING
...
-------------------------------------------------------------------------------
   ...
   and map it to the SOLO_EQUAT_NORM frame defined in the SOLO
   ...
   A metakernel defined to use this file should look like this:
         ...
         ...
              ...
              $DATA/fk/solo_ANC_soc-sc-fk_V00.tf
              $DATA/fk/solo_sc_equat_norm_v00.tf
  ...
  \begindata
      ...
      TKFRAME_-144000_RELATIVE   = 'SOLO_EQUAT_NORM'
