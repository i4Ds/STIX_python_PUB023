...
------------------------------------------------------------------------------
   ...
   SOLO mission specific generic frames:
      ...
      SOLO_GAE                    Geocentric Aries Ecliptic     (GAE)
      SOLO_GSE                    Geocentric Solar Ecliptic     (GSE)
      SOLO_HEE                    Heliocentric Earth Ecliptic   (HEE)
   ...
   (**) NAIF are in the process of defining generic frames for the different
        bodies of the Solar System. The preliminary equivalent name for GSE is 
        EARTH_SUN_ECL. The definitions from [5] and [8] diverge for the 
        principal and secondary axis are swapped. An evaluation using the 
        NAIF utility FRMDIFF provides the following differences:

           #
           # Sampling of 263689 rotations
           #
           #    from 'EARTH_SUN_ECL' (300399005) to 'GSE' (1803311)
           #    computed using
           #
           #       solo_ANC_soc-pred-default-mk_V020_20170619_001.tm
           #
           # with a 3600.0000000000 second (0:01:00:00.000000) step size
           # within the continuous time period
           #
           #    from '2000 JUN 01 00:01:04.184' TDB (13089664.184894 TDB sec)
           #    to   '2030 JUL 01 00:01:09.184' TDB (962366469.18412 TDB sec)
           #
    
           1) Average
            
              1a) Rotation (rad):                   0.0000018940328672775
            
            
           2) RMS of
            
              2a) Rotation (rad):                   0.0000022075655902158
            
            
           3) Maximum rotation
            
              3a) Rotation (rad):                   0.0000053383599339350
            
              3b) Epoch (TDB, seconds past J2000):  599493664.18489
            
              3c) Epoch (TDB, calendar format):     2018-DEC-31-02:01:04.184

        This differences in principle indicate that either definitions can be
        used.


   (***) NAIF are in the process of defining generic frames for the different
        bodies of the Solar System. The preliminary equivalent name for HEE is 
        SUN_EARTH_ECL. The definitions from [5] and [8] diverge for the 
        principal and secondary axis are swapped. An evaluation using the 
        NAIF utility FRMDIFF provides the following differences:
           ...
           # Sampling of 263689 rotations
           #
           #    from 'SUN_EARTH_ECL' (1000010002) to 'HEE' (1810311)
           #    computed using
           #
           #       solo_ANC_soc-pred-default-mk_V020_20170619_001.tm
           #
...
------------------------------------------------------------------------
  ...
  \begindata
      ...
      FRAME_-144991_SEC_AXIS         = 'Y'
      FRAME_-144991_SEC_VECTOR_DEF   = 'OBSERVER_TARGET_VELOCITY'
      FRAME_-144991_SEC_OBSERVER     = 'SOLO'
      FRAME_-144991_SEC_TARGET       = 'SUN'
      FRAME_-144991_SEC_ABCORR       = 'NONE'
      FRAME_-144991_SEC_FRAME        = 'J2000'
...
Geocentric Aries Ecliptic of Date frame (SOLO_GAE)
------------------------------------------------------------------------
  ...
  \begindata
      ...
      FRAME_-144995_ROTATION_STATE   = 'ROTATING'
