...
Meta-kernel for Solar Orbiter Dataset v100 -- Predicted Default 20190705_001
============================================================================
...
-------------------------------------------------------------------------
   ...
   If you use these data for your investigations please cite it with:
...
-------------------
   ...
   This file was created on July 5, 2019 by Marc Costa Sitja ESA/ESAC.
   ...
   \begindata
     ...
     KERNELS_TO_LOAD   = (
                           ...
                           '$KERNELS/fk/solo_ANC_soc-sci-fk_V03.tf'
