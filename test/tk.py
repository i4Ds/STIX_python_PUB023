...
class MainFrame:
    ...
    def __init__(self, master):
        self.master = master
        master.title("TM packet capture")
        self.f=None
        ...
        self.start_button = Button(master, text="Start Capture", command=lambda: self.start())
    ...
    def loop(self):
        ...
        if self.buf.endswith(b'<-->'):
            ...
            if self.buf[0:9] == 'TM_PACKET'.encode():
                ...
                num += 1
                self.msg='Received TM ({}, {})(SPID {})  at {} '.format(data2[3].decode(), 
